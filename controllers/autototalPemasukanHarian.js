...
const getPemasukanHarianByUserHandler = async (req, res) => {
  ...
  try {
    ...
    for (const account of accounts) {
      ...
      // Loop setiap pemasukan untuk hitung total per hari
...
module.exports = getPemasukanHarianByUserHandler;
